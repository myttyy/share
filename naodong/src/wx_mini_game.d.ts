...
declare const wx: {
    ...
    navigateToMiniProgram(object: {appId:string,path:string,extraData:string,envVersion:string,success:(res:any)=>void,fail:(res:any)=>void,complete:(res:any)=>void}): void;
    /**
     * 监听小游戏回到前台的事件
     */
