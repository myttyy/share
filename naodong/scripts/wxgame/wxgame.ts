    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                // if(filename == "libs/modules/leancloud-storage/leancloud-storage.js" || filename == "libs/modules/leancloud-storage/leancloud-storage.min.js")
                // {
                //     content += ";window.leancloud-storage = leancloud-storage;"
                // }
