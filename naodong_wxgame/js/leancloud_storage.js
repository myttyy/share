var egret = window.egret;(function webpackUniversalModuleDefinition(root, factory) {
        root["AV"] = factory();
    ...
    return (function (modules) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _require2 = __webpack_require__(3), getSessionToken = _require2.getSessionToken, ajax = _require2.ajax;
            // 计算 X-LC-Sign 的签名方法
            ...
            var createApiUrl = function createApiUrl(_ref) {
                var _ref$service = _ref.service, service = _ref$service === undefined ? 'api' : _ref$service, _ref$version = _ref.version, version = _ref$version === undefined ? '1.1' : _ref$version, path = _ref.path;
            ...
            var request = function request(_ref2) {
                var service = _ref2.service, version = _ref2.version, method = _ref2.method, path = _ref2.path, query = _ref2.query, _ref2$data = _ref2.data, data = _ref2$data === undefined ? {} : _ref2$data, authOptions = _ref2.authOptions, _ref2$signKey = _ref2.signKey, signKey = _ref2$signKey === undefined ? true : _ref2$signKey;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var ajax = function ajax(_ref) {
                var method = _ref.method, url = _ref.url, query = _ref.query, data = _ref.data, _ref$headers = _ref.headers, headers = _ref$headers === undefined ? {} : _ref$headers, onprogress = _ref.onprogress, timeout = _ref.timeout;
            ...
            var transformFetchOptions = function transformFetchOptions() {
                var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}, keys = _ref2.keys, include = _ref2.include, includeACL = _ref2.includeACL;
                var fetchOptions = {};
                if (keys) {
            ...
            var setValue = function setValue(target, key, value) {
                ...
                segs.forEach(function (seg) {
                    if (currentTarget[seg] === undefined)
                        currentTarget[seg] = {};
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            /* WEBPACK VAR INJECTION */ (function (global) {
                ...
                var _require = __webpack_require__(3), inherits = _require.inherits, parseDate = _require.parseDate;
                var AV = global.AV || {};
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _require = __webpack_require__(3), isNullOrUndefined = _require.isNullOrUndefined;
            var _require2 = __webpack_require__(0), extend = _require2.extend, isObject = _require2.isObject;
            ...
            AV.init = function init(options) {
                ...
                var appId = options.appId, appKey = options.appKey, masterKey = options.masterKey, hookKey = options.hookKey, _options$region = options.region, region = _options$region === undefined ? 'cn' : _options$region, serverURLs = options.serverURLs, disableCurrentUser = options.disableCurrentUser, production = options.production, realtime = options.realtime;
                if (AV.applicationId)
        ...
        /***/ (function (module, exports, __webpack_require__) {
            "use strict";
            var _require = __webpack_require__(3), ajax = _require.ajax;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var Promise = __webpack_require__(1);
            var _require = __webpack_require__(3), tap = _require.tap, transformFetchOptions = _require.transformFetchOptions;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            (function () {
                var crypt = __webpack_require__(41), utf8 = __webpack_require__(13).utf8, isBuffer = __webpack_require__(42), bin = __webpack_require__(13).bin, 
                // The core
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _ = __webpack_require__(0);
            var AVError = __webpack_require__(4);
            var _require = __webpack_require__(2), _request = _require._request;
            var _require2 = __webpack_require__(3), isNullOrUndefined = _require2.isNullOrUndefined, ensureArray = _require2.ensureArray, transformFetchOptions = _require2.transformFetchOptions, setValue = _require2.setValue, findValue = _require2.findValue;
                ...
                /** @lends AV.Object.prototype */ {
                    ...
                    _applyOpSet: function _applyOpSet(opSet, target) {
                        ...
                        AV._objectEach(opSet, function (change, key) {
                            var _findValue = findValue(target, key), _findValue2 = _slicedToArray(_findValue, 3), value = _findValue2[0], actualTarget = _findValue2[1], actualKey = _findValue2[2];
                    ...
                    _rebuildEstimatedDataForKey: function _rebuildEstimatedDataForKey(key) {
                        ...
                        AV._arrayEach(this._opSetQueue, function (opSet) {
                            var op = opSet[key];
                            if (op) {
                                var _findValue3 = findValue(self.attributes, key), _findValue4 = _slicedToArray(_findValue3, 3), value = _findValue4[0], actualTarget = _findValue4[1], actualKey = _findValue4[2];
                    ...
                    fetch: function fetch() {
                        ...
                        return request.then(function (response) {
                            ...
                            if (!fetchOptions.keys)
                                self._cleanupUnsetKeys(fetchedAttrs);
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _ = __webpack_require__(0);
            var AVError = __webpack_require__(4);
            var _require = __webpack_require__(2), AVRequest = _require._request, request = _require.request;
            var Promise = __webpack_require__(1);
                ...
                return new Promise(function (resolve, reject) {
                    wx.login({
                        success: function success(_ref) {
                            var code = _ref.code, errMsg = _ref.errMsg;
                            if (code) {
                                resolve(code);
                            }
                            else {
            ...
            var mergeUnionDataIntoAuthData = function mergeUnionDataIntoAuthData(authData, unionId) {
                var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}, _ref2$unionIdPlatform = _ref2.unionIdPlatform, unionIdPlatform = _ref2$unionIdPlatform === undefined ? 'weixin' : _ref2$unionIdPlatform, _ref2$asMainAccount = _ref2.asMainAccount, asMainAccount = _ref2$asMainAccount === undefined ? false : _ref2$asMainAccount;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var Promise = __webpack_require__(1);
            var AVError = __webpack_require__(4);
            var _require = __webpack_require__(2), _request = _require._request, request = _require.request;
            var _require2 = __webpack_require__(3), ensureArray = _require2.ensureArray, transformFetchOptions = _require2.transformFetchOptions;
            ...
            module.exports = function (AV) {
                ...
                /** @lends AV.Query.prototype */ {
                    ...
                    scan: function scan() {
                        var _this2 = this;
                        var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}, orderedBy = _ref.orderedBy, batchSize = _ref.batchSize;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var Promise = __webpack_require__(1);
            var _require = __webpack_require__(3), inherits = _require.inherits;
            var _require2 = __webpack_require__(2), request = _require2.request;
            ...
            module.exports = function (AV) {
                ...
                /** @lends AV.LiveQuery.prototype */ {
                    ...
                    init: function init(query) {
                        var _ref2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}, _ref2$subscriptionId = _ref2.subscriptionId, userDefinedSubscriptionId = _ref2$subscriptionId === undefined ? AV._getSubscriptionId() : _ref2$subscriptionId;
                        ...
                        return Promise.resolve(userDefinedSubscriptionId).then(function (subscriptionId) {
                            return AV._config.realtime.createLiveQueryClient(subscriptionId).then(function (liveQueryClient) {
                                var _query$toJSON = query.toJSON(), where = _query$toJSON.where, keys = _query$toJSON.keys, returnACL = _query$toJSON.returnACL;
                                var queryJSON = {
                                    where: where,
                                    keys: keys,
                                    returnACL: returnACL,
        ...
        /***/ (function (module, exports, __webpack_require__) {
            "use strict";
            var _ = __webpack_require__(0);
            var _require = __webpack_require__(3), tap = _require.tap;
            module.exports = function (AV) {
                /**
                 * @class
                 * @example
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _ = __webpack_require__(0);
            var AVRequest = __webpack_require__(2)._request;
            var _require = __webpack_require__(3), getSessionToken = _require.getSessionToken;
            module.exports = function (AV) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _ = __webpack_require__(0);
            var AVError = __webpack_require__(4);
            var _require = __webpack_require__(2), request = _require.request;
            module.exports = function (AV) {
                /**
                 * 包含了使用了 LeanCloud
